...
export const LoginMagicLinkEmail = ({
  userName,
  magicLink,
}: LoginMagicLinkEmailProps) => (
  <Html>
    <Head />
    <Preview>Connexion à votre compte Planora</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Connexion à Planora</Heading>

          <Text style={greeting}>Bonjour{userName ? ` ${userName}` : ''},</Text>

          <Text style={text}>
            Vous avez demandé à vous connecter à votre compte Planora.
            Cliquez sur le bouton ci-dessous pour accéder à votre espace en toute sécurité :
          </Text>

          {/* CTA Button */}
          <Section style={buttonContainer}>
            <Button style={button} href={magicLink}>
              ✨ Se connecter à Planora
            </Button>
          </Section>
          ...
          <Section style={noticeBox}>
            <Text style={noticeText}>
              ...
              <br />
              Ce lien de connexion est valide pendant 1 heure et à usage unique pour votre sécurité.
          ...
          {/* Footer */}
          <Text style={footer}>
            Cet email a été envoyé automatiquement par Planora.
          </Text>
...
// Styles - Premium Design (same as WelcomeEmployeeEmail for consistency)
const main = {
